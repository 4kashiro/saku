...
const STAMP_SHAPES = {
  "bar-h": [[0, 1], [1, 1], [2, 1]],
  "bar-v": [[1, 0], [1, 1], [1, 2]],
  "l-corner": [[1, 0], [1, 1], [1, 2], [0, 2]],
  "t-junction": [[0, 1], [1, 1], [2, 1], [1, 2]],
  cross: [[1, 0], [0, 1], [1, 1], [2, 1], [1, 2]],
  step: [[0, 2], [1, 2], [1, 1], [2, 1], [2, 0]],
};
const STAMP_LABELS = {
  "bar-h": "Batang Datar",
  "bar-v": "Batang Tegak",
  "l-corner": "Sudut L",
  "t-junction": "Simpang T",
  cross: "Silang",
  step: "Tangga",
};
const STAMP_ORDER = ["bar-h", "bar-v", "l-corner", "t-junction", "cross", "step"];
const BUILTIN_STAMPS = STAMP_ORDER.map((id) => ({
  id, kind: "cells", w: 3, h: 3, cells: STAMP_SHAPES[id], label: STAMP_LABELS[id], builtin: true,
}));
